package com.nataliaF.client.tests.services;
...
import com.nataliaF.client.repositories.ClientRepository;
import com.nataliaF.client.services.ClientService;
import com.nataliaF.client.services.exceptions.DatabaseException;
import com.nataliaF.client.services.exceptions.ResourceNotFoundException;
import com.nataliaF.client.tests.factory.ClientFactory;
...
public class ClientServiceTests {
	...
	@Test
	public void findByIdShouldDoNothingWhenIdExistis() {
	...
	@Test
	public void updateShouldDoNothingWhenIdExistis() {
				
		Assertions.assertDoesNotThrow(() -> {
			service.update(existingId, null);
		});
